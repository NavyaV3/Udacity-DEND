...
songplay_table_create = ("""CREATE TABLE songplays(songplay_id serial PRIMARY KEY, start_time bigint NOT NULL, user_id varchar NOT NULL, level varchar, song_id varchar, artist_id varchar , session_id varchar, location varchar, user_agent varchar)        
""")
...
time_table_create = ("""CREATE TABLE time(start_time timestamp PRIMARY KEY, hour int, day varchar, week varchar, month varchar, year int, weekday varchar)
""")
